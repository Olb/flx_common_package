...
class SimpleTrainingListPage extends StatelessWidget {
  final User user;
  final Api api;
  SimpleTrainingListPage(this.user, this.api);
  ...
  Widget build(BuildContext context) {
    ...
    return TrainingProvider(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<SimpleTrainingList>(
          stream: trainingBloc.training,
          initialData: null,
              ...
              return new ListView.builder(
                ...
                itemBuilder: (itemBuilderCtx, index) {
                  return new ListTile(
                    ...
                    onTap: () {
                      SimpleTraining training = snapshot.data.trainingList[index];
